...
public class instm183_LTL_CTLCond {
	...
	public MyInt a422009172 = new MyInt(-68, "a422009172");
	public MyBool cf = new MyBool(true, "cf");
	public MyInt a2108127495 = new MyInt(-44, "a2108127495");
	public MyInt a1522448132 = new MyInt(173, "a1522448132");
	public MyString a1745113960 = new MyString("h");
...
private  void calculateOutputm1(MyString input) {
    ...
    if(I.myIf(I.bool2)) {
    	cf = new MyBool(false, "cf");
    	a1745113960 = new MyString("h", true);
...
I.myAnd( I.bool2,cf,I.bool1);
	...
	I.myAnd( I.bool2,cf,I.bool1);
 	if(I.myIf(I.bool2)) {
    	cf = new MyBool(false, "cf", true);
    	a1745113960 = new MyString("g", true);
...
I.myAnd( I.bool2,I.bool1,cf);
 if(I.myIf(I.bool2)) {
    	cf = new MyBool(false, "cf",true);
    	a1745113960 = new MyString("i", true);
    	I.myPrint("usr2_ai1_ce4");
}
}
...
I.myAnd( I.bool2,I.bool1,cf);
	...
	if(I.myIf(I.bool2)) {
    	cf = new MyBool(false, "cf", true);
    	a1745113960 = new MyString("e", true);
...
public static void myEquals(MyBool a, MyString b, MyString c, instm183_LTL_CTLCond o) {
...
public static void myEquals(MyBool a, MyString b, String c, instm183_LTL_CTLCond o) {
...
public static void myEquals(MyBool a, String b, MyString c, instm183_LTL_CTLCond o){ myEquals(a, new MyString(b), c, o); }
...
public static void myEquals(MyBool a, String b, String c, instm183_LTL_CTLCond o){
