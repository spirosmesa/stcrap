...
class Branch{
	...
	public int branchDistance(String input) {
		return 1;
	}
...
public class instm183_LTL_CTLBranchDistance {
	static BufferedReader stdin = new BufferedReader(new InputStreamReader(System.in));

	//String: input
	public static HashSet<Branch> branches = new HashSet<>();
	...
	public static void main(String[] args) throws Exception {
		instm183_LTL_CTLBranchDistance eca = new instm183_LTL_CTLBranchDistance();
		while(true) {
			eca.reset();
...
public static void myEquals(MyBool a, MyString b, MyString c,
							instm183_LTL_CTLBranchDistance o) {
...
public static void myEquals(MyBool a, MyString b, MyString c,
		instm183_LTL_CTLBranchDistance o, Branch br) {
	a.val = (b.val.equals(c.val));
...
public static void myEquals(MyBool a, String b, MyString c, instm183_LTL_CTLBranchDistance o){ myEquals(a, new MyString(b), c, o); }
...
public static void myEquals(MyBool a, String b, String c, instm183_LTL_CTLBranchDistance o){
